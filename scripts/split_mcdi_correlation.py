'''
split_mcdi_correlation.py

Script to determine if correlations of split accuracy scores 
...
data_file = master_dir + '/Anaphora/data/data_analysis/processed_data/split_mcdi_accuracy.csv'
...
total_output = {}
total_output['split accuracy'] = stats.pearsonr(accuracy, mcdi_total)

noun_output  = {}
noun_output['split accuracy'] = stats.pearsonr(accuracy, mcdi_noun)
