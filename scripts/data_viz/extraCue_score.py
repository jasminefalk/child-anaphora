...
x = df['age']
y = df['extra cue accuracy']
ax = sns.regplot(x, y, data=df, color='#AD1963')
ax.set(xlabel='Age (in months)', ylabel="Accuracy score")
plt.title('Age vs. Resolution Accuracy Score of Anaphora Paired with Extratextual Cues')
plt.show()
...
plt.title('MCDI ProdTotal vs. Resolution Accuracy Score of Anaphora Paired with Extratextual Cues')
plt.show()
...
plt.title('MCDI ProdCountNoun vs. Resolution Accuracy Score of Anaphora Paired with Extratextual Cues')
plt.show()