...
Script to generate plots of child anaphora scores as 
...
x = df['age']
y = df['Resolution Accuracy Score']
ax = sns.regplot(x, y, data=df, color='#AD1963')
ax.set(xlabel='Age (in months)', ylabel="Anaphora resolution accuracy")
plt.title('Age vs. Anaphora Resolution Accuracy Score')
plt.show()
...
ax.set(xlabel='MCDI ProdTotal', ylabel="Anaphora resolution accuracy")
plt.title('MCDI ProdTotal vs. Anaphora Resolution Accuracy Score')
plt.show()
...
y = df['overall accuracy']
ax = sns.regplot(x, y, data=df, color='#19AD63')
ax.set(xlabel='MCDI ProdCountNoun', ylabel="Anaphora resolution accuracy")
plt.title('MCDI ProdCountNoun vs. Anaphora Resolution Accuracy Score')
plt.show()