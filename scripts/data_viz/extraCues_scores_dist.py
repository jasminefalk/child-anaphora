'''
extraCues_scores_dist.py

Script to generate distribution plot of 
extratextually-cued anaphora resolution accuracy scores
...
plt.title('Distribution of Extratextually-Cued Anaphora Resolution Accuracy Scores')
plt.show()