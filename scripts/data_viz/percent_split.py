...
utterances containing split anaphora as a function of 
...
plt.title('Age vs. Percentage of Anaphoric Utterances Containing Split Anaphora')
plt.show()
...
plt.title('MCDI ProdTotal vs. Percentage of Anaphoric Utterances Containing Split Anaphora')
plt.show()
...
plt.title('MCDI ProdCountNoun vs. Percentage of Anaphoric Utterances Containing Split Anaphora')
plt.show()