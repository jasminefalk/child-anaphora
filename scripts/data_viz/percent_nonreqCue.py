...
x = df['age']
y = df['percent not required of total extra cues']
ax = sns.regplot(x, y, data=df, color='#AD1963')
ax.set(xlabel='Age (in months)', ylabel="% of Anaphoric Utterances")
plt.title('Age vs. Percentage of Extratextually-Cued Anaphoric Utterances that Used Non-Required Cues ')
plt.show()
