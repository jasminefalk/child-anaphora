'''
percent_visualCue.py

Script to generate plots of percentage of anaphoric 
utterances containing visually cued anaphora as a function of 
...
plt.title('Age vs. Percentage of Anaphoric Utterances Containing Visual Cue Anaphora')
plt.show()
...
plt.title('MCDI ProdTotal vs. Percentage of Anaphoric Utterances Containing Visual Cue Anaphora')
plt.show()
...
plt.title('MCDI ProdCountNoun vs. Percentage of Anaphoric Utterances Containing Visual Cue Anaphora')
plt.show()