'''
percent_verbalCue.py

Script to generate plots of percentage of anaphoric 
utterances containing verbally cued anaphora as a function of 
...
plt.title('Age vs. Percentage of Anaphoric Utterances Containing Verbal Cue Anaphora')
plt.show()
...
plt.title('MCDI ProdTotal vs. Percentage of Anaphoric Utterances Containing Verbal Cue Anaphora')
plt.show()
...
plt.title('MCDI ProdCountNoun vs. Percentage of Anaphoric Utterances Containing Verbal Cue Anaphora')
plt.show()